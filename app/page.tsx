            ...
            >
              <div id="auth_header" className="text-center mb-8">
                ...
                <p id="auth_portal_sub" className="text-slate-500 text-sm mt-1">
                  Masukkan nama atau email &amp; kata sandi bebas untuk masuk langsung
                </p>
              </div>
              ...
              <form id="auth_form" onSubmit={handleAuthSubmit} className="space-y-5">
                ...
                <div id="auth_email_group" className="space-y-1.5">
                  <label htmlFor="auth_email" className="block text-xs font-semibold text-slate-600 uppercase tracking-wider font-mono">Email / Username Bebas</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Masukkan nama atau email bebas..."
